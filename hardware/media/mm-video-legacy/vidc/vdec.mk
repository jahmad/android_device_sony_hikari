...
libmm-vdec-inc          += hardware/qcom/media/default/mm-core/inc
#DRM include - Interface which loads the DRM library
libmm-vdec-inc	        += $(OMX_VIDEO_PATH)/DivxDrmDecrypt/inc
libmm-vdec-inc          += device/sony/hikari/hardware/display/libgralloc
libmm-vdec-inc          += device/sony/hikari/hardware/display/libcopybit
libmm-vdec-inc          += device/sony/hikari/hardware/display/libqservice
libmm-vdec-inc          += device/sony/hikari/hardware/display/libqdutils
libmm-vdec-inc          += frameworks/native/include/media/openmax
libmm-vdec-inc          += frameworks/native/include/media/hardware
libmm-vdec-inc          += device/sony/hikari/hardware/media/libc2dcolorconvert
